...
import "./Cart.css";
const Header = () => {
  const { cart, cartCount, cartTotal, clearCart, removeCart, updateCart } =
          ...
          {cart.length === 0 ? (
            ...
            <Container className="cart-items-container">
              {cart.map((item) => (
                <Row
                  key={item.id}
                  className="cart-item-row mb-3 align-items-center"
                >
                  {/* Product Image */}
                  ...
                  <Col xs={6} className="cart-item-info-col">
                    ...
                    <div className="cart-item-quantity-control">
                      ...
                      <span className="cart-item-quantity-display">
                        {item.quantity}
                      </span>
                      <Button
                        variant="outline-primary"
